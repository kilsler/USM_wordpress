...
1. После распаковки архива вордпресса заходим по адрессу `localhost/wp_lab2`
2. Заполняем форму и продолжаем создание сайта
3. Авторизируемся созданным аккаунтом
## Шаг 3. Первоначальные настройки сайта
1. Изменяем название сайта `wp_penguin_blog` и часовой пояс `UTC+3` => `UTC+2`
2. Настраиваем постоянные ссылки `http://localhost/wp_lab2` => `http://localhost/wp_lab2`
